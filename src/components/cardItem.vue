<template>
    <div class="ui card">
        ...
        <div class="content"> <a class="header">{{item.firstName + ' ' + item.lastName }}</a>
            <div class="meta"> <span class="date">Mobile : {{item.mobileNo}} </span> </div>
            <div class="meta"> <span class="date">Email : {{item.email}}</span> </div>
            <div class="meta"> <span class="date">Facebook : {{item.facebook}} </span> </div>
        </div>
